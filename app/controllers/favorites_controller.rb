class FavoritesController < ApplicationController
    ...
    def create 
        ...
        respond_to do |format|
          unless params.dig(:favorite, :favorite_article_list_id) == ""
            ...
            format.turbo_stream { flash.now[:notice] = "この記事をお気に入りリスト #{ @favorite_article_list.list_title } に追加しました。" }  
          else 
    ...
    def correct_user 
      @favorite_article_list = current_user.favorite_article_lists.find(params.dig(:favorite, :favorite_article_list_id))
